  ...
  return (
    <React.Fragment>
      <header className="w-full lg:min-h-screen overflow-hidden">
        ...
        <svg className='absolute top-40 md:top-[21rem] lg:top-auto lg:-bottom-24 z-20 rotate-180' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 100" preserveAspectRatio="none">
      ...
      <main className="container mt-40 md:mt-[25rem] lg:mt-0 lg:my-16 ">
        ...
        <p className="mt-4 md:mt-8 mb-8 text-center p-2 rounded-3xl bg-sky-500 text-white max-w-xs mx-auto font-normal text-md">Week Of May 12th To 18th</p>
        
        <div className="group mx-auto mt-10 px-5 lg:px-10 max-w-5xl rounded-3xl flex flex-row items-center justify-between hover:bg-sky-50/75 transition duration-300 ease-in">
          <Image src={Img1} className="h-40  lg:h-96 w-auto" alt="ki6u na" draggable="false" />
          <div className='items-center-safe pl-4 pr-2'>
            ...
            <span className='flex flex-row space-x-1 md:space-x-3.5 mt-3.5 lg:mt-7'>
              <button className="px-1.5 md:px-3 py-1 rounded-2xl text-[10px] md:text-md lg:text-lg border border-cyan-800 group-hover:border group-hover:border-cyan-800 group-hover:translate-x-5 transition duration-300">Learn More</button>
        ...
        <div className="group mx-auto mt-10 px-5 lg:px-10 max-w-5xl rounded-3xl flex flex-row items-center justify-between hover:bg-sky-50/75 transition duration-300 ease-in">
          <Image src={Img2} className="h-40  lg:h-96 w-auto" alt="ki6u na" draggable="false" />
          <div className='items-center-safe pl-4 pr-2'>
