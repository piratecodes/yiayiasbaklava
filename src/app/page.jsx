...
export default function Home() {
  return (
    <React.Fragment>
      ...
      <main className="container mt-40 md:mt-[25rem] lg:mt-0 lg:my-16 ">
        <p className="mt-10 ml-1/12 text-center text-6xl font-bold text-sky-500">Weekly Creations</p>
        <p className="my-8 text-center p-2 rounded-3xl bg-sky-500 text-white max-w-xs mx-auto font-normal text-md">Week Of May 12th To 18th</p>
        
        <div className="group mx-auto mt-10 px-10 max-w-5xl rounded-3xl flex flex-row items-center justify-between hover:bg-sky-50/75 transition duration-300 ease-in">
          <Image src={Img1} className="h-48 -translate-x-24 md:translate-x-0 lg:h-96 w-auto" alt="ki6u na" draggable="false" />
          <div className='items-center-safe pr-5'>
            ...
            <span className='flex flex-row space-x-5 mt-7'>
              ...
              <button className="px-1.5 md:px-3 py-1 rounded-2xl text-xs md:text-md ld:text-lg border border-cyan-800 group-hover:border group-hover:border-cyan-800 group-hover:translate-x-5 transition duration-300 group-hover:bg-sky-500 group-hover:text-white">Order Now</button>
            </span>
          </div>
        </div>

        <p className="mt-24 ml-1/12 text-center text-6xl font-bold text-sky-500">Yia Yia's Classic</p>
        <p className="flex flex-row items-center my-3 text-center p-2 rounded-3xl underline underline-offset-4 decoration-sky-500 max-w-xs mx-auto font-semibold text-lg"><FaMapMarkerAlt className='fill-sky-500' /> <span>Visit Your Local Store Near You</span></p>
        <div className="group mx-auto mt-10 px-10 max-w-5xl rounded-3xl flex flex-row items-center justify-between hover:bg-sky-50/75 transition duration-300 ease-in">
          <Image src={Img2} className="h-48 -translate-x-24 md:translate-x-0 lg:h-96 w-auto" alt="ki6u na" draggable="false" />
          <div className='items-center-safe pr-5'>
