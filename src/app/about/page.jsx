                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/3">
                        ...
                        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
                            ...
                            <p className="mb-3 font-normal text-gray-500">All our sweets are prepared fresh and delivered straight from our shelves to your doorstep—guaranteeing a refined dessert experience in every bite.</p>
                        </div>
                    ...
                    <div className="p-4 md:w-1/3">
                        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
                            ...
                            <p className="mb-3 font-normal text-gray-500">Our packaging is more than a box—it’s a heartfelt expression of joy and care. Thoughtfully designed for gifting, each order delivers a truly personalized experience.</p>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/3">
                        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
                            ...
                            <p className="mb-3 font-normal text-gray-500">Discover flavors that honor our heritage. Every bite tells the story of our Greek and Middle Eastern roots—crafted with tradition, love, and culture.</p>
                        </div>
                    </div>
                </div>
            </section>
