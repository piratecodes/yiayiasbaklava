...
export default function Nav() {
  ...
  return (
    <nav className={`sticky top-0 left-0 py-2 w-full max-h-20 z-50 transform transition-normal ease-initial ${pathName === "/" ? scrollPosition > 50 ? 'bg-sky-100 shadow-md' : 'bg-transparent' : 'bg-sky-100 shadow-md'}`}>
