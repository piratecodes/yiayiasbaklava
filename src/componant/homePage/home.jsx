  ...
  return (
    <React.Fragment>
      ...
      <header className="w-full h-full relative -translate-y-20">
        ...
        <video className="md:hidden z-10 w-auto h-screen object-cover brightness-90" autoPlay muted playsInline loop>
          <source src={home.data.slider[0].image} type="video/mp4" />
        </video>
        ...
        <div className='absolute left-10 md:inset-x-10 bottom-1/6 z-30'>
          <p className='font-semibold font-mono font-lg lg:text-2xl text-center text-white'>Retail pieces are larger than shown</p>
