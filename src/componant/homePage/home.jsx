  ...
  return (
    <React.Fragment>
      ...
      <header className="w-full h-full relative -translate-y-20">
        <video className="hidden md:block z-10 w-full h-auto object-cover brightness-90" autoPlay muted playsInline loop>
          <source src="/Horizontal-Baklava.webm" type="video/mp4" />
        </video>
        <video className="md:hidden z-10 w-ull h-auto object-cover brightness-90" autoPlay muted playsInline loop>
          <source src={home.data.slider[0].image} type="video/mp4" />
        </video>
        ...
        <div className='absolute left-10 md:inset-x-10 bottom-1/6 z-30'>
          <p className='font-semibold font-mono font-xl lg:text-2xl text-center text-white'>Retail pieces are larger than shown</p>
      ...
      <main className="container md:mt-10 lg:mt-0 ">
        <p className="lg:mt-10 text-center text-6xl font-bold text-sky-500">{home.data.weekly_timeline ? formatWeekRange(home.data.weekly_timeline) : "This Week's Special"}</p>
