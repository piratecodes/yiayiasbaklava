  ...
  return (
    <React.Fragment>
      ...
      <main className="container md:mt-10 lg:mt-0 ">
        <h1 className="mt-4 md:mt-8 mb-4 text-center py-2 px-4 rounded-3xl bg-sky-500 text-white w-full max-w-xs mx-auto font-normal text-xl">{home.data.weekly_timeline ? formatWeekRange(home.data.weekly_timeline) : "This Week's Special"}</h1>
